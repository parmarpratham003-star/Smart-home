...
>
  <div className="w-full">
    <div className="max-w-[1250px] mx-auto px-6">
      ...
      <div className="max-w-[520px] text-white space-y-5 -mt-2 md:-mt-25">
        ...
        <h1
          ...
          className="hero-heading font-extrabold tracking-tight 
        ...
        <p
          ...
          className="text-xs sm:text-sm md:text-base text-white/90 max-w-[360px] leading-relaxed"
        >
          We craft innovative smart home experiences that combine
          technology, comfort, and modern design to elevate your everyday living.
        </p>
